...
<body>
    <div class="header">
        ...
        <div class="headtext">
            <h3 style="margin:0px; text-transform:uppercase;">MAHKAMAH AGUNG REPUBLIK INDONESIA PENGADILAN NEGERI
                MARTAPURA</h3>
    ...
    <div class="container">
        <div class="isi">
            <h4 style="text-align:center;">AGENDA SPPD DARI TANGGAL
                {{carbon\carbon::parse($tgl_mulai)->translatedFormat('d F Y')}} SAMPAI TANGGAL
                {{carbon\carbon::parse($tgl_selesai)->translatedFormat('d F Y')}}</h4>
