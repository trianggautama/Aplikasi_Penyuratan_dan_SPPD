...
<body>
    ...
    <div class="container">
        <div class="isi">
            <h4 style="text-align:center;">AGENDA SURAT KELUAR DARI TANGGAL {{carbon\carbon::parse($tgl_mulai)->translatedFormat('d F Y')}} SAMPAI TANGGAL {{carbon\carbon::parse($tgl_selesai)->translatedFormat('d F Y')}}</h4>
