                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>12312121</td>
                                                    <td>III/d</td>
                                                    <td>Staf Pelaksana</td>
                                                    <td>Dishub</td>
                                                    <td>LLAJ</td>
                                                    <td>						
                                                        <!-- <a class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-eye"></i> </span><span class="btn-text"> </span></a> -->
                                                        <a href="{{Route('pegawaiEdit')}}" class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-edit"></i> </span><span class="btn-text"> </span></a>
