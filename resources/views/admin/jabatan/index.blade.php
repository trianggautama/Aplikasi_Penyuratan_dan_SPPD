                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>J12</td>
                                                    <td>Kepala Seksi A</td>
                                                    <td>						
                                                        <!-- <button class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-eye"></i> </span><span class="btn-text"> </span></button> -->
                                                        <a href="{{Route('jabatanEdit')}}" class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-edit"></i> </span><span class="btn-text"> </span></a>
