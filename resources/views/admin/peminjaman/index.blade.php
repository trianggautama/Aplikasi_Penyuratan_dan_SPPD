                                    ...
                                    <div class="table-wrap">
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>121313/BG-1/12121</td>
                                                    <td>John Doe</td>
                                                    <td>17 Januari 2020</td>
                                                    <td>21 Januari 2020</td>
                                                    <td>4 hari</td>
                                                    <td>Peminjaman Motor Dinas</td>
                                                    <td>		
                                                        <a href="{{Route('peminjamanEdit')}}" class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-edit"></i> </span><span class="btn-text"> </span></a>
