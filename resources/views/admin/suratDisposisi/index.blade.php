                                    ...
                                    <div class="table-wrap">
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>1</td>
                                                    <td>121313/BG-1/2020</td>
                                                    <td>Surat Himbauan</td>
                                                    <td>Kasi A</td>
                                                    <td>Tolong Pelajari</td>
                                                    <td>Biasa</td>
                                                    <td>12 Januari 2020</td>
                                                    <td>		
                                                        <a href="{{Route('suratDisposisiShow')}}" class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-eye"></i> </span><span class="btn-text"> </span></a>				
                                                        <a href="{{Route('suratDisposisiEdit')}}" class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-edit"></i> </span><span class="btn-text"> </span></a>
