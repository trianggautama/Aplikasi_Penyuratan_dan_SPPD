...
<div class="hk-pg-wrapper">
    ...
    <div class="container mt-xl-50 mt-sm-30 mt-15">
        ...
        <div class="hk-pg-header align-items-top">
            ...
            <div class="d-flex">
                <button class="btn btn-sm btn-danger btn-wth-icon icon-wthot-bg mb-15" ><span
                                        ...
                                        <table id="datable_1" class="table table-hover w-100 display pb-30">
                                            ...
                                            <tbody>
                                               <tr>
                                                   <td>1</td>
                                                   <td>Andi</td>
                                                   <td>12131141212121</td>
                                                   <td>III/d</td>
                                                   <td> Kasi A</td>
                                                    <td>
                                                           <a href="" class="btn btn-sm btn-outline-light m-1"><span class="icon-label"><i class="fa fa-info-circle"></i> </span><span class="btn-text"> </span></a>
