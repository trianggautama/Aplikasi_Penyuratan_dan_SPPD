                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>						
                                                        ...
                                                        <a href="{{Route('unitEdit')}}" class="btn btn-sm btn-outline-light  "><span class="icon-label"><i class="fa fa-edit"></i> </span><span class="btn-text"> </span></a>
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="kode_unit" placeholder="kode_unit">
                            </div>
                            <div class="form-group">
                                <label for="exampleDropdownFormEmail1">Nama unit</label>
                                <input type="text" class="form-control" id="nama_unit" placeholder="nama_unit">
                            </div>
